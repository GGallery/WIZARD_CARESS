...
<div id="j-main-container" class="span10">
    ...
    <div class="span12">
        <form action="<?php echo JRoute::_('index.php?option=com_wizard'); ?>" method="post" name="adminForm" id="adminForm">
                        ...
                        <div class="js-stools-container-bar">
                            ...
                            <div class="js-stools-container-bar">
                                ...
                                <div class="btn-wrapper input-append">
                                    ...
                                    <input type="text" name="filter_search" id="filter_search" value="<?php echo $this->escape($this->searchterms); ?>" title="<?php echo JText::_('COM_wizard_SELEZIONATITOLODESCRIZIONEETC'); ?>" />
                                ...
                                <!--                                <option value=""> - --><?php //echo JText::_('COM_wizard_SELEZIONAAREATEMATICA'); ?><!-- - </option>-->
