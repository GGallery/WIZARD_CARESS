<h2>ACTIVITY 3: ESTRATEGIAS DE APRENDIZAJE Y DEFINICIÓN DE CRITERIOS DE EVALUACIÓN </h2>

<span class="avanzamento">
        <span class="lightarrow"><br>
           PASO 1: IDENTIFICACIÓN DE LAS "LIMITACIONES DE TU DISEÑO"

        </span>

        <span class="darkarrow"><br>
            PASO 2: DEFINE ESTRATEGIAS DE APRENDIZAJE
        </span>

        <span class="lightarrow">
           PASO 3: DEFINE CRITERIOS DE EVALUACIÓN, HERRAMIENTAS Y ACTIVIDADES
        </span>
...
<p>
    Coge la tabla en la que has detallado los resultados de aprendizaje de tu módulo de aprendizaje compensatorio (MAC).
</p>

<span class="focus">
        <p>IDENTIFICA UNA ESTRATEGIA DE APRENDIZAJE ADECUADA PARA CADA RESULTADO DE APRENDIZAJE</p>
    </span>

<p>
    No existe una fórmula mágica para resolver un problema de diseño, de la misma manera que no existen estrategias formativas que sean válidas y útiles para todos los contextos, aprendices y resultados de aprendizaje. <strong>Sin embargo, si se tienen en cuenta las “limitaciones en el diseño”</strong> es posible definir las estrategias de aprendizaje más adecuadas para cada resultado de aprendizaje esperado.</strong>
</p>
...
<p>De esta manera, si fuera necesario ten en cuenta</p>

<span class="focus">
        <p>REVISAR LA AGRUPACIÓN DE RESULTADOS DE APRENDIZAJE EN UNIDADES DE APRENDIZAJE TENIENDO EN CUENTA LAS ESTRATEGIAS DE APRENDIZAJE </p>
    </span>

<p>
    En cuanto a la identificación de las estrategias de aprendizaje adecuadas, un número de teorías, prácticas y patrones bien establecidos han sido formalizados y compartidos por expertos.
</p>
...
<span class="focus">
        <p>IDENTIFICA POSIBLES MÓDULOS DE FORMACIÓN EN LÍNEA</p>
    </span>

<p>
    Los materiales interactivos multimedia, videos o los artículos descargables pueden en ocasiones reemplazar las clases presenciales tradicionales, especialmente cuando se abordan conocimientos teóricos o fácticos. 
</p>
