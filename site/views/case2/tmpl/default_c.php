<div class="wizardbkg">
    <h1> <span class="glossary" title="See description on Glossary on the right menu">HHCP</span> IN A COUNTRY</h1>
    ...
    <div class="row-fluid">
        ...
        <div class="span9">
            <h3>So you want to integrate the CARESS Framework with information about a specific <span class="glossary" title="See description on Glossary on the right menu">HHCP</span> in a Country. What kind of information you would like to insert/update? </h3>
            <h4>What kind of information you would like to insert/update</h4>

            <ul class="custom_ul">
                <li>
                    <a href="index.php?option=com_wizard&view=case2&tipo=c1"><button  type="button" class="btn btn-primary btn-lg"> > </button></a> New
                ...
                <li>
                    <a href="index.php?option=com_wizard&view=case2&tipo=c2"><button  type="button" class="btn btn-primary btn-lg"> > </button></a>
                    Learning Outcome - insert or update one/more learning outcome for a Vet Course targeting a <span title="See description on Glossary on the right menu" class="glossary">HHCP</span> in a country
                </li>
                <li>
